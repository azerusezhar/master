                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('master.update', $master) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="kode" id="kode" value="{{ old('kode', $master->kode) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $master->nama) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="3"
                                      ...
                                      placeholder="Deskripsi (opsional)">{{ old('deskripsi', $master->deskripsi) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                <option value="aktif" {{ old('status', $master->status) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                <option value="nonaktif" {{ old('status', $master->status) == 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                        </div>
